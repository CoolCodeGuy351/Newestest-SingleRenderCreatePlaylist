...
$(document).ready(function() {
    ...
    function createNewPlaylist(){
        ...
        var newPlaylistContainer = $('<div>').addClass('new-playlist-container');
        var divQuestionOne = $('<div>').addClass('div-question-one');
        var divQuestionTwo = $('<div>').addClass('div-question-two');
        var divQuestionThree = $('<div>').addClass('div-question-three');
        var divQuestionFour = $('<div>').addClass('div-question-four');
        var divQuestionFive = $('<div>').addClass('div-question-five');

        var qOneText = $('<h6>').addClass('q-one-text').text('Choose a genre');
        var qOneButtonContainer = $('<div>').addClass('q-one-button-div');
        divQuestionOne.append(qOneText);
        ...
        for(var i = 0; i < genreChoicesArray.length ; i++){
                if(i===0 || i===5 || i===11 || i===16 || i===21){
                    ...
                    if(i !== 0){
                        ...
                        qOneButtonContainer.append(space);
                    }

                    var titleRender = $('<button>').addClass('title').text(genreChoicesArray[i]);
                    qOneButtonContainer.append(titleRender);

                } else {

                    var buttonRender = $('<button>').addClass('genre-buttons-question-one').text(genreChoicesArray[i]).attr('value', genreNumberArray[i]);
                    qOneButtonContainer.append(buttonRender);

                }
        }

        divQuestionOne.append(qOneButtonContainer);
        newPlaylistContainer.append(divQuestionOne);

        // Q 2 STUFF STARTS HERE ///////////////////////////////////////////////////////////////////////////

        var qTwoDiv = $('<div>').addClass('q-two-div');

        var qTwoButtonDiv = $('<div>').addClass('q-two-button-div'); 
        var qTwoText =$('<h6>').addClass('q-two-html').text("Would you like a mainstream movie or indie movie?")/*.css('display',block)*/;
        var qTwoButtonIndie = $('<button>').addClass('q-two-button').text("Indie Movie").attr("value", "200000");
        var qTwoButtonMainstream = $('<button>').addClass('q-two-button').text("Mainstream Movie").attr("value", "200000");


        qTwoButtonDiv.append(qTwoButtonIndie);
        qTwoButtonDiv.append(qTwoButtonMainstream);
        qTwoDiv.prepend(qTwoText);
        qTwoDiv.append(qTwoButtonDiv);

        divQuestionTwo.append(qTwoDiv);
        newPlaylistContainer.append(divQuestionTwo)
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        // Q 3 STUFF STARTS HERE ///////////////////////////////////////////////////////////////////////////

        var qThreeDiv = $('<div>').addClass('q-three-div');
        var qThreeButtonDiv = $('<div>').addClass('q-three-button-div');
        var qThreeText =$('<p>').addClass('q-three-html').text("Pick the year range")/*.css('display',block)*/;
        var bRangeOne = $('<button>').addClass('q-three-button').text('1950').attr("value", "1950");
        var bRangeTwo = $('<button>').addClass('q-three-button').text('1970').attr("value", "1970");
        var bRangeThree = $('<button>').addClass('q-three-button').text('1990').attr("value", "1990");
        var bRangeFour = $('<button>').addClass('q-three-button').text('2017').attr("value", "2017");

        // Combine content and render to page
        qThreeButtonDiv.prepend(bRangeOne);
        qThreeButtonDiv.append(bRangeTwo);
        qThreeButtonDiv.append(bRangeThree);
        qThreeButtonDiv.append(bRangeFour);

        qThreeDiv.prepend(qThreeText);
        qThreeDiv.append(qThreeButtonDiv);


        ////////////////////////////////////////////////////////////////////////////////////////////////////
        newPlaylistContainer.append(divQuestionThree).append(divQuestionFour).append(divQuestionFour);

        $(document).on("click", ".q-two-button" , function(){
            
            userProfile.push(parseInt($(this).val()));

        })

        newPlaylistContainer.append(qOneButtonContainer);
        ...
        $(document).on("click", ".q-three-button", function(){
        ...
        */
        ...
        $('#render-div').append(newPlaylistContainer)
